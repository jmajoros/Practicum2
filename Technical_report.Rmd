...
We endeavor to render a detailed analysis of the proposed new product, the USB Toaster, based on the comprehensive data gathered by our firm. We plan to effectively communicate an examination of the data collected in both samples (below) and highlight which demographic data points may be of interest, and most importantly, to predict how successful the USB Toaster will be. 
...
=======
P2<-read.csv("P2.csv")
>>>>>>> a43e8e270be02b54e2796c9a4fc442146ab47a52
P2$job<-factor(P2$job)  #converting factor variables into factors
P2$marital<-factor(P2$marital)
P2$education<-factor(P2$education)
P2$default<-factor(P2$default)
